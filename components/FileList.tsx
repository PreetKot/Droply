        ...
        >
          <div className="overflow-x-auto">
            <Table
              ...
              classNames={{
                base: "min-w-full",
                th: "bg-black text-lime-400 font-medium text-sm",
                td: "py-4 text-lime-200",
              }}
            >
              <TableHeader>
              ...
              <TableBody>
                {filteredFiles.map((file) => (
                  <TableRow
                    key={file.id}
                    className={`hover:bg-lime-950/40 transition-colors ${
                  ...
                  >
                    <TableCell>
                      <div className="flex items-center gap-3">
                        <FileIcon file={file} />
                        <div>
                          <div className="font-medium flex items-center gap-2 text-lime-200">
                            ...
                            {file.isFolder && (
                              <Tooltip content="Folder">
                                <Folder className="h-3 w-3 text-lime-400" />
                              </Tooltip>
                            )}
                          ...
                          <div className="text-xs text-lime-500 sm:hidden">
